...
dados2 %>%
  ...
  filter(
         ...
         str_detect(activity_units, 'animal'),
         gas == 'co2e_100yr',
         original_inventory_sector ==c('enteric-fermentation-cattle-pasture','manure-management-cattle-feedlot',"enteric-fermentation-cattle-feedlot","manure-left-on-pasture-cattle")) %>%
  mutate(
    classe_emissao = case_when(
      emissions_quantity <0.1e6 ~ '< 0.1 Mton',
      emissions_quantity <0.4e6 ~ '< 0.4 Mton',
